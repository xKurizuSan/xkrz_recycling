...
Config.Target = true                                   -- Ob ihr das Target System nutzen wollt oder nicht.
Config.UseSkillCheck = false                             -- Ob der Spieler ein SkillCheck machen soll, damit es nicht einfaches "E" Farmen ist.
